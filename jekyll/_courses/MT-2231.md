---
cnum: MT-2231
subtitle: "Basic Seamanship"
title: "MMA Course MT-2231"
major: D
---
...
* {% table 25.html#ABD-C1.4, ABD-C1.4 %} *Knowledge of hoisting and dipping flags and the main single-flag signals. (A, B, G, H, O, P, Q)*
* {% table 25.html#ABD-C1.3, ABD-C1.3 %} *Use and handling of deck and cargo-handling gear and equipment*
* {% table 25.html#ABD-C1.3, ABD-C1.3 %} *Access arrangements*
* {% table 25.html#ABD-C1.2, ABD-C1.2 %} *Rig and unrig bosun’s chairs and staging*
* {% table 25.html#ABD-C1.2, ABD-C1.2 %} *Rig and unrig pilot ladders, hoists, rat-guards and gangways*
* {% table 25.html#ABD-C1.2, ABD-C1.2 %} *Use marlin spike seamanship skills, including the proper use of knots, splices and stoppers*
* {% table 25.html#ABD-C1.1, ABD-C1.1 %} *Function and uses of winches, windlasses, capstans and related equipment*
* {% table 25.html#ABD-C1.1, ABD-C1.1 %} *Fibre and wire ropes, cables and chains, including their construction, use, markings, maintenance and proper stowage*
* {% table 25.html#ABD-C1.1, ABD-C1.1 %} *Ability to use and understand basic signals for the operation of equipment, including winches, windlasses, cranes, and hoists*
* {% table 25.html#ABD-C1.1, ABD-C1.1 %} *Ability to operate anchoring equipment under various conditions, such as anchoring, weighing anchor, securing for sea, and in emergencies*
* {% table 25.html#ABD-A2.2, ABD-A2.2 %} *Working knowledge of the procedures and order of events associated with mooring to a buoy or buoys*
* {% table 25.html#ABD-A2.1, ABD-A2.1 %} *Function of mooring and tug lines and how each line functions as part of an overall system*
* {% table 25.html#ABD-A2.1, ABD-A2.1 %} *Capacities, safe working loads, and breaking strengths of mooring equipment, including mooring wires, synthetic and fibre lines, winches, anchor windlasses, capstans, bitts, chocks and bollards*
* {% table 25.html#ABD-A2.1, ABD-A2.1 %} *Procedures and order of events for making fast and letting go mooring and tug lines and wires, including towing line*
* {% table 25.html#ABD-A2.1, ABD-A2.1 %} *Procedures and order of events for the use of anchors in various operation*

**Demonstrate proficiency in the following skills:**

* {% assessment ABD-4J7A %} *Demonstrate rigging and unrigging a bosun's chair* {% image new.jpg %}
* {% assessment ABD-4J9A2 %} *Marlinspike seamanship - knots II* {% image new.jpg %}
* {% assessment ABD-4J9A3 %} *Marlinspike seamanship - splicing* {% image new.jpg %}
* {% assessment ABD-4J9A4 %} *Marlinspike seamanship - line handling* {% image new.jpg %}
