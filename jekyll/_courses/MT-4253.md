...
* {% assessment OICNW-2-2D %} *Keep a safe anchor watch* {% image mod.jpg %}
...
* {% assessment OICNW-2D1E %} *Maneuver to avoid risk of collision - crossing* {% image new.jpg %}
* {% assessment OICNW-2D3B %} *Voyage plan - preparation* {% image new.jpg %}
* {% assessment OICNW-2D4A %} *Situational awareness* {% image new.jpg %}
* {% assessment OICNW-2D6A %} *Vessel traffic systems (VTS)* {% image new.jpg %}
* {% assessment OICNW-2D7E %} *BRM Condition II or III - prioritization* {% image new.jpg %}
* {% assessment ADB-4J11A %} *Trace out and describe a piping system* {% image new.jpg %}
* {% assessment RFPNW-1K %} *Helmsman* {% image new.jpg %}
* {% assessment RFPNW-3K4B %} *Relief of the helmsman* {% image new.jpg %}
* {% assessment RFPNW-2K %} *Lookout* {% image new.jpg %}
* {% assessment RFPNW-3K4A %} *Relief of the lookout* {% image new.jpg %}
