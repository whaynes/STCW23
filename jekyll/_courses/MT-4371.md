...
* {% assessment OICNW-1-1C %} *Obtain a celestial fix* {% image mod.jpg %}
...
* {% assessment OICNW-1-5F %} *Azimuth of the sun* {% image mod.jpg %}
* {% assessment OICNW-1-6A %} *Steering gear test*
* {% assessment OICNW-1-6B %} *Set weather controls*
* {% assessment OICNW-2-2A %} *Watch relief* {% image mod.jpg %}
