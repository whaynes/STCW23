...
In order to satisfy  [NVIC 12-14  Task  4.2]({{site.baseurl}}/assets/images/nvic-12-14.pdf), MMA students must:
...
[OICNW-A4.2]({{site.baseurl}}/tables/21.html#OICNW-A4.2) *Navigation using ECDIS*
