...
In order to satisfy  [NVIC 18-14  Task  10.3.A]({{site.baseurl}}/assets/images/nvic-18-14.pdf), MMA students must:
...
[ABE-C4.1]({{site.baseurl}}/tables/35.html#ABE-C4.1) Working knowledge of safe working practices and personal shipboard safety including mechanical safety
