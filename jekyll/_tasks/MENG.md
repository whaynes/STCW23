...
|:-----:|:----:|:------------|:-------:|
| 1. | {% task 1E1A, OICEW 1.1.A %} | Pre watch inspection | {% assessment OICEW-4-1A %} in {% course EN-4231 %} |
| 2. | {% task 1E1B, OICEW 1.1.B %} | Keep watch (Motor) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 3. | {% task 1E1C, OICEW 1.1.C %} | Keep watch (Steam) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 4. | {% task 1E1D, OICEW 1.1.D %} | Keep watch (Gas Turbine) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 5. | {% task 1E1E, OICEW 1.1.E %} | Maintain log book ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 6. | {% task 1E1F, OICEW 1.1.F %} | Hand over the watch | {% assessment OICEW-4-1B %} in {% course EN-4231 %} |
| 7. | {% task 1E2A, OICEW 1.2.A %} | Change-over to local control systems ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-1E2A %} in {% course EN-3233 %} |
| 8. | {% task 1E3A, OICEW 1.3.A %} | Observe safety precautions during watch | {% assessment OICEW-4-2A %} in {% course EN-3131 %} |
| 9. | {% task 1E3B, OICEW 1.3.B %} | Take immediate action (fire) | {% course MT-1111 %}|
| 10. | {% task 1E3C, OICEW 1.3.C %} | Take immediate action (accident) | {% course MT-1111 %}|
| 11. | {% task 1E3D, OICEW 1.3.D %} | Take immediate action (oil system fire or accident) | {% course MT-1111 %}|
| 12. | {% task 1E4, OICEW 1.4 %} | ERM | {% course EN-4234 %}|
| 13. | {% task 2E1, OICEW 2.1 %} | English | {% course ST-0999 %}|
| 14. | {% task 3E1A, OICEW 3.1.A %} | Test internal communications | {% assessment OICEW-5-1A %} in {% course EN-4231 %} |
| 15. | {% task 4E1A, OICEW 4.1.A %} | Understand equipment operating principles | {% course EN-2111 %}|
| 16. | {% task 4E1B, OICEW 4.1.B %} | Light off boiler | {% assessment OICEW-5-2A %} in {% course EN-3131 %} |
| 17. | {% task 4E1C, OICEW 4.1.C %} | Secure boiler | {% assessment OICEW-5-2B %} in {% course EN-3131 %} |
| 18. | {% task 4E2A, OICEW 4.2.A %} | Understand safety and emergency procedures for propulsion machinery | {% course EN-4131 %}|
| 19. | {% task 4E2B, OICEW 4.2.B %} | Respond to propulsion boiler carry-over | {% course EN-3131 %}|
| 20. | {% task 4E2C, OICEW 4.2.C %} | Prepare propulsion diesel engine for operation | {% assessment OICEW-5-1J %} in {% course EN-4131 %} |
| 21. | {% task 4E3A, OICEW 4.3.A %} | Prepare steam turbine for operation | {% assessment OICEW-5-1L %} in {% course EN-4231 %} |
| 22. | {% task 4E3B, OICEW 4.3.B %} | Prepare gas turbine for operation | {% assessment OICEW-4-3B %} in {% course EN-3233 %} |
| 23. | {% task 4E3C, OICEW 4.3.C %} | Monitor diesel engine operation ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 24. | {% task 4E3D, OICEW 4.3.D %} | Monitor steam turbine operation | {% assessment OICEW-5-1M %} in {% course EN-2231 %} |
| 25. | {% task 4E3E, OICEW 4.3.E %} | Monitor gas turbine operation | {% assessment OICEW-4-3E %} in {% course EN-3233 %} |
| 26. | {% task 4E3F, OICEW 4.3.F %} | Secure propulsion diesel | {% assessment OICEW-5-1K %} in {% course EN-4131 %} |
| 27. | {% task 4E3G, OICEW 4.3.G %} | Secure steam turbine operation | {% assessment OICEW-5-1N %} in {% course EN-4231 %} |
| 28. | {% task 4E3H, OICEW 4.3.H %} | Secure gas turbine operation | {% assessment OICEW-4-3H %} in {% course EN-3233 %} |
| 29. | {% task 4E3I, OICEW 4.3.I %} | Monitor auxiliary boiler ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4E3I %} in {% course EN-3131 %} |
| 30. | {% task 4E3J, OICEW 4.3.J %} | Test boiler water | {% assessment OICEW-5-2D %} in {% course EN-3131 %} |
...
| 67. | {% task 8E1B, OICEW 8.1.B %} | Welding projects | {% assessment OICEW-1-1B %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1C %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1F %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1G %} in {% course EN-2112 %} <br/> {% course EN-2112 %}|
...
| 13. | {% task 6G2A, ABE 6.2.A %} | Electrical safety | {% course EN-3111L %}<br/> {% course EN-4231 %}|
| 14. | {% task 6G3A, ABE 6.3.A %} | Electrical shock hazards | {% course EN-1112 %}<br/> {% course EN-4231 %}|
| 15. | {% task 7G1A, ABE 7.1.A %} | Surface preparation and coating | {% course CC-MANT %}|
| 16. | {% task 7G2A, ABE 7.2.A %} | Safety guidelines and shipboard instructions | {% course MT-1111 %}|
| 17. | {% task 7G3A, ABE 7.3.A %} | Surface preparation techniques | {% course CC-MANT %}|
| 18. | {% task 7G4A, ABE 7.4.A %} | Waste disposal | {% course CC-MANT %}<br/> {% course ST-0999D %}|
| 19. | {% task 7G5A, ABE 7.5.A %} | Tool selection | {% assessment OICEW-2-1A %} in {% course ST-0999E %} <br/> {% assessment OICEW-2-1B %} in {% course ST-0999E %} <br/> {% assessment OICEW-2-1C %} in {% course ST-0999E %} <br/> {% course ST-0999E %}|
| 20. | {% task 7G6A, ABE 7.6.A %} | Maintenance and use of hand and power tools | {% course EN-2112 %}<br/> {% course ST-0999E %}|
| 21. | {% task 8G1A, ABE 8.1.A %} | Stowage and securing of stores and equipment | {% course CC-MANT %}|
| 22. | {% task 8G1B, ABE 8.1.B %} | Stores handling gear, cranes, derricks, and winches | {% assessment ABDE-DE-1 %} in {% course ST-0999D %} <br/> {% course CC-MANT %}|
| 23. | {% task 9G1A, ABE 9.1.A %} | Sources of operational pollution | {% course ST-0999D %}|
| 24. | {% task 9G1B, ABE 9.1.B %} | Precautions to prevent pollution of the marine environment | {% course ST-0999D %}|
| 25. | {% task 9G2A, ABE 9.2.A %} | Use of anti-pollution equipment | {% course ST-0999D %}|
| 26. | {% task 9G3A, ABE 9.3.A %} | Waste generation and disposal | {% course CC-MANT %}<br/> {% course ST-0999D %}|
| 27. | {% task 10G1A, ABE 10.1.A %} | Electrical safety procedures | {% course EN-1112 %}<br/> {% course EN-3111L %}<br/> {% course EN-4231 %}|
| 28. | {% task 10G2A, ABE 10.2.A %} | Lockout/tagout procedures | {% course EN-1112 %}<br/> {% course EN-3111L %}|
| 29. | {% task 10G3A, ABE 10.3.A %} | Mechanical safety | {% course EN-1112 %}|
| 30. | {% task 10G4A, ABE 10.4.A %} | Safe working practices and personal shipboard safety | {% course EN-1112 %}|
| 31. | {% task 10G5A, ABE 10.5.A %} | Safety when working aloft | {% course EN-1112 %}|
| 32. | {% task 10G6A, ABE 10.6.A %} | Characteristics of enclosed spaces | {% course EN-1112 %}|
| 33. | {% task 10G6B, ABE 10.6.B %} | Dangers of enclosed space entry | {% course EN-1112 %}|
| 34. | {% task 10G6C, ABE 10.6.C %} | Safe working practice for enclosed space entry | {% course EN-1112 %}|
| 35. | {% task 10G7A, ABE 10.7.A %} | Back injury prevention | {% course EN-1112 %}|
| 36. | {% task 10G8A, ABE 10.8.A %} | Response to a chemical or biohazard spill | {% course EN-1112 %}|
| 37. | {% task 10G8B, ABE 10.8.B %} | Procedures for exposure to a chemical or biohazard spill | {% course EN-1112 %}|
| 38. | {% task 10G9A, ABE 10.9.A %} | Use of personal safety equipment | {% course EN-1112 %}|
{: .sortable .tasks}
...
| No.   | NVIC Task | Description | Location |
|:-----:|:----:|:------------|:-------:|
| 1. | {% task 1H1A, RFPEW 1.1.A %} | Engine room round | {% assessment OICEW-4-1A %} in {% course EN-4231 %} |
| 2. | {% task 1H1BS, RFPEW 1.1.B(S) %} | Monitor electricity generating plant (Steam) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 3. | {% task 1H1BM, RFPEW 1.1.B(M) %} | Monitor electricity generating plant (Motor) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 4. | {% task 1H1BG, RFPEW 1.1.B(G) %} | Monitor electricity generating plant (Gas Turbine) ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 5. | {% task 1H1C, RFPEW 1.1.C %} | Monitor LO/FO purification systems ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 6. | {% task 1H1D, RFPEW 1.1.D %} | Monitor compressed air plant ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 7. | {% task 1H1E, RFPEW 1.1.E %} | Monitor refrigeration and air-conditioning plants ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 8. | {% task 1H1F, RFPEW 1.1.F %} | Determine tank and pressure-vessel levels ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 9. | {% task 1H1G, RFPEW 1.1.G %} | Charge a potable water pressure tank with compressed air ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 10. | {% task 1H1HS, RFPEW 1.1.H(S) %} | Monitor steam distilling plant ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 11. | {% task 1H1HM, RFPEW 1.1.H(M) %} | Monitor jacket water evaporator ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 12. | {% task 1H1HMG, RFPEW 1.1.H(M/G) %} | Monitor reverse osmosis plant ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 13. | {% task 1H1IS, RFPEW 1.1.I(S) %} | Monitor main steam turbine propulsion unit ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-5-1M %} in {% course EN-2231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 14. | {% task 1H1IM, RFPEW 1.1.I(M) %} | Monitor main diesel engine propulsion unit ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 15. | {% task 1H1IG, RFPEW 1.1.I(G) %} | Monitor main gas turbine propulsion unit | {% assessment OICEW-4-3E %} in {% course EN-3233 %} |
| 16. | {% task 1H1J, RFPEW 1.1.J %} | Monitor propulsion shafting and bearings ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 17. | {% task 1H1K, RFPEW 1.1.K %} | Monitor steering gear ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 18. | {% task 1H2A, RFPEW 1.2.A %} | Add clean oil to engine and deck machinery ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 19. | {% task 1H2B, RFPEW 1.2.B %} | Lubricate a grease-lubricated bearing | {% assessment OICEW-8-2A %} in {% course EN-2111 %} |
| 20. | {% task 1H2C, RFPEW 1.2.C %} | Shift and clean a basket-type duplex strainer ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment RFPEW-1H2C %} in {% course EN-1211 %} |
| 21. | {% task 1H2D, RFPEW 1.2.D %} | Clean LO/FO purifier ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-8E3A %} in {% course EN-4131 %} |
| 22. | {% task 1H2E, RFPEW 1.2.E %} | Take up on a gate/globe valve stuffing-box gland | {% assessment OICEW-8-2E %} in {% course EN-2231 %} |
| 23. | {% task 1H2F, RFPEW 1.2.F %} | Take on fresh water | {% assessment ABE-1-6A %} in {% course EN-1211 %} |
| 24. | {% task 1H3A, RFPEW 1.3.A %} | Pump out bilges | {% assessment OICEW-6-2A %} in {% course EN-2231 %} |
| 25. | {% task 1H3B, RFPEW 1.3.B %} | Monitor oily-water separator ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-9-1C %} in {% course EN-2231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 26. | {% task 1H3C, RFPEW 1.3.C %} | Monitor sewage treatment plants ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-9-1B %} in {% course EN-2231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 27. | {% task 2H1A, RFPEW 2.1.A %} | Relieve the watch ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1B %} in {% course EN-4231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 28. | {% task 2H1B, RFPEW 2.1.B %} | Hand over the watch ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1B %} in {% course EN-4231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 29. | {% task 2H1C, RFPEW 2.1.C %} | Pre-start check of a diesel engine | {% assessment OICEW-7-1B %} in {% course EN-4131 %} |
| 30. | {% task 2H2A, RFPEW 2.2.A %} | Operate internal communications systems ![]({{site.baseurl}}/assets/images/new.jpg)  | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
