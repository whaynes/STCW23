...
| 27. | {% task 2H1A, 2.1.A %} | Relieve the watch | {% assessment OICEW-4-1B %} in {% course EN-4231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 28. | {% task 2H1B, 2.1.B %} | Hand over the watch | {% assessment OICEW-4-1B %} in {% course EN-4231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
...
| 42. | {% task 3H1I, 3.1.I %} | Assist in the operation of the soot blower | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
