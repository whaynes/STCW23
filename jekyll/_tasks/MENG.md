...
|:-----:|:----:|:------------|:-------:|
| 1. | {% task 1E1A, 1.1.A %} | Pre watch inspection | {% assessment OICEW-4-1A %} in {% course EN-4231 %} |
| 2. | {% task 1E1B, 1.1.B %} | Keep watch (Motor) | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 3. | {% task 1E1C, 1.1.C %} | Keep watch (Steam) | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
| 4. | {% task 1E1D, 1.1.D %} | Keep watch (Gas Turbine) | {% assessment OICEW-4-1C %} in {% course EN-4231 %} |
...
| 12. | {% task 1E4, 1.4 %} | ERM | {% course EN-4234 %}|
| 13. | {% task 2E1, 2.1 %} | English | {% course ST-0999 %}|
| 14. | {% task 3E1A, 3.1.A %} | Test internal communications | {% assessment OICEW-5-1A %} in {% course EN-4231 %} |
| 15. | {% task 4E1A, 4.1.A %} | Understand equipment operating principles | {% course EN-2111 %}|
| 16. | {% task 4E1B, 4.1.B %} | Light off boiler | {% assessment OICEW-5-2A %} in {% course EN-3131 %} |
...
| 31. | {% task 4E3K, 4.3.K %} | Treat boiler water | {% assessment OICEW-5-2D %} in {% course EN-3131 %} |
| 32. | {% task 4E3L, 4.3.L %} | Bottom blow boiler | {% assessment OICEW-5-2C %} in {% course EN-3131 %} |
| 33. | {% task 4E3M, 4.3.M %} | Change over low pressure air compressor | {% assessment OICEW-5-1D %} in {% course EN-2111 %} |
| 34. | {% task 4E3N, 4.3.N %} | Start fresh water generator | {% assessment OICEW-5-1F %} in {% course EN-4231 %} |
| 35. | {% task 4E3O, 4.3.O %} | Shut down fresh water generator | {% assessment OICEW-5-1G %} in {% course EN-4231 %} |
| 36. | {% task 4E3P, 4.3.P %} | Start fresh water distiller | {% assessment OICEW-5-1F %} in {% course EN-4231 %} |
| 37. | {% task 4E3Q, 4.3.Q %} | Shut down fresh water distiller | {% assessment OICEW-5-1G %} in {% course EN-4231 %} |
| 38. | {% task 4E3R, 4.3.R %} | Start oil purifier | {% assessment OICEW-5-1H %} in {% course EN-3233 %} |
| 39. | {% task 4E3S, 4.3.S %} | Shut down oil purifier | {% assessment OICEW-5-1I %} in {% course EN-3233 %} |
| 40. | {% task 4E3T, 4.3.T %} | Start refrigeration system | {% assessment OICEW-5-1B %} in {% course EN-3213 %} |
| 41. | {% task 4E3U, 4.3.U %} | Monitor refrigeration system | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 42. | {% task 4E3V, 4.3.V %} | Secure refrigeration system | {% assessment OICEW-5-1C %} in {% course EN-3213 %} |
| 43. | {% task 4E3W, 4.3.W %} | Start and secure a reverse osmosis plant | {% assessment OICEW-5-1F %} in {% course EN-4231 %} <br/> {% assessment OICEW-5-1G %} in {% course EN-4231 %} |
| 44. | {% task 5E1A, 5.1.A %} | Understand pumps, piping systems and controls | {% course EN-1211 %}<br/> {% course EN-2111 %}<br/> {% course EN-3216 %}|
| 45. | {% task 5E2A, 5.2.A %} | Transfer fuel | {% assessment OICEW-6-1A %} in {% course EN-3131 %} |
| 46. | {% task 5E2B, 5.2.B %} | Ballast a tank | {% assessment OICEW-5E2B %} in {% course EN-3131 %} |
| 47. | {% task 5E2C, 5.2.C %} | De-ballast a tank | {% assessment OICEW-5E2B %} in {% course EN-3131 %} |
| 48. | {% task 5E2D, 5.2.D %} | Pump engine room bilges | {% assessment OICEW-6-2A %} in {% course EN-2231 %} |
| 49. | {% task 5E2E, 5.2.E %} | Pump cargo-hold or shaft alley bilges | {% assessment OICEW-6-2A %} in {% course EN-2231 %} |
| 50. | {% task 5E3A, 5.3.A %} | Monitor oily-water separator | {% assessment OICEW-9-1C %} in {% course EN-2231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 51. | {% task 6E1A, 6.1.A %} | Understand electrical generation and distribution | {% course EN-3111 %}|
| 52. | {% task 6E1B, 6.1.B %} | Inspect and start a diesel generator | {% assessment OICEW-7-1A %} in {% course EN-4131 %} <br/> {% assessment OICEW-7-1B %} in {% course EN-4131 %} <br/> {% assessment OICEW-7-1D %} in {% course EN-3233 %} |
| 53. | {% task 6E1C, 6.1.C %} | Inspect and start a steam turbo-generator | {% assessment OICEW-7-1C %} in {% course EN-3233 %} |
| 54. | {% task 6E1D, 6.1.D %} | Change over generators | {% assessment OICEW-7-1D %} in {% course EN-3233 %} <br/> {% assessment OICEW-7-1E %} in {% course EN-3111L %} |
| 55. | {% task 6E1E, 6.1.E %} | Understand motor controllers, sequential control, and high voltage | {% course EN-3111 %}<br/> {% course EN-3111L %}<br/> {% course EN-3216 %}|
| 56. | {% task 6E2A, 6.2.A %} | Understand basic electronics | {% course EN-3212 %}|
| 57. | {% task 6E3A, 6.3.A %} | Understand automation and control systems | {% course EN-3216 %}|
| 58. | {% task 7E1A, 7.1.A %} | Conduct insulation resistance test | {% assessment OICEW-3-1D %} in {% course EN-4231 %} <br/> {% assessment OICEW-7E4A %} in {% course EN-4231 %} |
| 59. | {% task 7E2A, 7.2.A %} | Troubleshoot motor controller | {% assessment OICEW-3-1B %} in {% course EN-3111L %} |
...
| 67. | {% task 8E1B, 8.1.B %} | Welding projects | {% assessment OICEW-1-1B %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1C %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1F %} in {% course EN-2112 %} <br/> {% assessment OICEW-1-1G %} in {% course EN-2112 %} <br/> {% course EN-2112 %}|
...
| 75. | {% task 9E1B, 9.1.B %} | Tighten pump packing | {% assessment OICEW-8-2A %} in {% course EN-2111 %} <br/> {% assessment OICEW-8E2B %} in {% course EN-2111 %} |
| 76. | {% task 9E1C, 9.1.C %} | Overhaul a reciprocating pump | {% assessment OICEW-8-2B %} in {% course EN-2111 %} |
| 77. | {% task 10E1A, 10.1.A %} | Start and secure sewage treatment system | {% assessment OICEW-9-1B %} in {% course EN-2231 %} |
| 78. | {% task 10E1B, 10.1.B %} | Start and secure oily-water separator | {% assessment OICEW-10E1B %} in {% course EN-3131 %} |
| 79. | {% task 11E1A, 11.1.A %} | Determine stability data for vessel | {% course EN-4151 %}|
| 80. | {% task 11E2A, 11.2.A %} | Ensure watertight integrity of the ship | {% course EN-4151 %}|
| 81. | {% task 11E3A, 11.3.A %} | Respond to partial loss of intact buoyancy | {% course EN-4151 %}|
| 82. | {% task 11E4A, 11.4.A %} | Identify ship's structural members | {% course EN-4151 %}|
| 83. | {% task 12E1, 12.1 %} | Firefighting | {% table 612, A-VI/1-2 %}<br/> {% table 63, A-VI/3 %}|
| 84. | {% task 13E1, 13.1 %} | Lifesaving | {% table 621, A-VI/2-1 %}|
| 85. | {% task 14E1, 14.1 %} | Medical Aid | {% course PE-0032 %}|
| 86. | {% task 15E1A, 15.1.A %} | Understand SOLAS, MARPOL and STCW Conventions. | {% course SS-4123 %}|
| 87. | {% task 16E1A, 16.1.A %} | Describe duties and responsibilities of vessel personnel | {% course MT-1111 %}|
| 88. | {% task 16E2A, 16.2.A %} | Describe maritime laws and conventions | {% course SS-4123 %}|
| 89. | {% task 16E3A, 16.3.A %} | Take on bunkers | {% assessment ABE-1-6A %} in {% course EN-1211 %} <br/> {% course CC-LEAD %}|
| 90. | {% task 16E4A, 16.4.A %} | Supervise a fire or emergency team | {% course FF-0108 %}|
| 91. | {% task 17E1, 17.1 %} | Personal Safety | {% table 611, A-VI/1-1 %}<br/> {% table 612, A-VI/1-2 %}<br/> {% table 613, A-VI/1-3 %}<br/> {% table 614, A-VI/1-4 %}|
{: .sortable .tasks}
...
| No.   | NVIC Task | Description | Location |
|:-----:|:----:|:------------|:-------:|
| 1. | {% task 1H1A, 1.1.A %} | Engine room round | {% assessment OICEW-4-1A %} in {% course EN-4231 %} |
| 2. | {% task 1H1BS, 1.1.B(S) %} | Monitor electricity generating plant (Steam) | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 3. | {% task 1H1BM, 1.1.B(M) %} | Monitor electricity generating plant (Motor) | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 4. | {% task 1H1BG, 1.1.B(G) %} | Monitor electricity generating plant (Gas Turbine) | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 5. | {% task 1H1C, 1.1.C %} | Monitor LO/FO purification systems | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 6. | {% task 1H1D, 1.1.D %} | Monitor compressed air plant | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 7. | {% task 1H1E, 1.1.E %} | Monitor refrigeration and air-conditioning plants | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 8. | {% task 1H1F, 1.1.F %} | Determine tank and pressure-vessel levels | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 9. | {% task 1H1G, 1.1.G %} | Charge a potable water pressure tank with compressed air | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
...
| 13. | {% task 1H1IS, 1.1.I(S) %} | Monitor main steam turbine propulsion unit | {% assessment OICEW-5-1M %} in {% course EN-3233 %} |
...
| 17. | {% task 1H1K, 1.1.K %} | Monitor steering gear | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 18. | {% task 1H2A, 1.2.A %} | Add clean oil to engine and deck machinery | {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
...
| 26. | {% task 1H3C, 1.3.C %} | Monitor sewage treatment plants | {% assessment OICEW-9-1B %} in {% course EN-2231 %} <br/> {% assessment OICEW-4-1D %} in {% course EN-2231 %} |
| 27. | {% task 2H1A, 2.1.A %} | Relieve the watch | {% assessment OICEW-4-1B %} in {% course EN-4231 %} |
| 28. | {% task 2H1B, 2.1.B %} | Hand over the watch | {% assessment OICEW-4-1B %} in {% course EN-4231 %} |
...
| 32. | {% task 2H3A, 2.3.A %} | Respond appropriately to alarms | {% assessment OICEW-4-2A %} in {% course EN-4231 %} |
| 33. | {% task 3H1A, 3.1.A %} | Maintain main boiler water level and steam pressures | {% assessment OICEW-5-2C %} in {% course EN-3131 %} |
| 34. | {% task 3H1B, 3.1.B %} | Maintain auxiliary boiler water level and steam pressures | {% assessment OICEW-4E3I %} in {% course EN-3131 %} |
| 35. | {% task 3H1C, 3.1.C %} | Monitor main propulsion boiler | {% assessment OICEW-5-2C %} in {% course EN-3131 %} |
...
| 39. | {% task 3H1F, 3.1.F %} | Assist preparing a main-propulsion boiler for light-off | {% assessment OICEW-5-2A %} in {% course EN-3131 %} |
| 40. | {% task 3H1G, 3.1.G %} | Assist in manual light-off, raising steam and cutting-in a boiler | {% assessment OICEW-5-2A %} in {% course EN-3131 %} |
| 41. | {% task 3H1H, 3.1.H %} | Assist in maintaining the fires on a main-propulsion boiler during maneuvering | {% assessment OICEW-5-2C %} in {% course EN-3131 %} |
| 42. | {% task 3H1I, 3.1.I %} | Assist in the operation of the soot blower | {% assessment OICEW-5-2C %} in {% course EN-3131 %} |
| 43. | {% task 4H1A, 4.1.A %} | Locate all engine-room escape routes | {% course EN-1112 %}|
| 44. | {% task 4H2A, 4.2.A %} | Locate firefighting and emergency equipment | {% course EN-1112 %}|
| 45. | {% task 4H2B, 4.2.B %} | Put a main or emergency fire-pump in service | {% assessment OICEW-6-1B %} in {% course EN-2231 %} |
{: .sortable .tasks}
