...
task_number: 8.1.C
location: "* Successfully complete MMA Assessment [OICEW-1-1A]({{site.baseurl}}/assessments/Engine/OICEW-1-1A) *Cut a circular hole using oxyacetylene process*" 
---


### MMA Method

In order to satisfy  [NVIC 17-14  Task  8.1.C]({{site.baseurl}}/assets/images/nvic-17-14.pdf), MMA students must:

* Successfully complete MMA Assessment [OICEW-1-1A]({{site.baseurl}}/assessments/Engine/OICEW-1-1A) *Cut a circular hole using oxyacetylene process*
