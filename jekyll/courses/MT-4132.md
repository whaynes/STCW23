...
* [OICNW-A5.2]({{site.baseurl}}/tables/21.html#OICNW-A5.2) *Initial action to be taken following a collision or a grounding*
* [OICNW-A5.2]({{site.baseurl}}/tables/21.html#OICNW-A5.2) *Initial damage assessment and control*
* [OICNW-A5.3]({{site.baseurl}}/tables/21.html#OICNW-A5.3) *Appreciation of the procedures to be followed for rescuing persons from the sea*
* [OICNW-A6.1]({{site.baseurl}}/tables/21.html#OICNW-A6.1) *Knowledge of the contents of the International Aeronautical and Maritime Search and Rescue (IAMSAR) Manual*
* [OICNW-A9.1]({{site.baseurl}}/tables/21.html#OICNW-A9.1) *the effects of deadweight, draught, trim, speed and under-keel clearance on turning circles and stopping distances*
* [OICNW-A9.1]({{site.baseurl}}/tables/21.html#OICNW-A9.1) *the effects of wind and current on ship handling*
* [OICNW-A9.1]({{site.baseurl}}/tables/21.html#OICNW-A9.1) *manoeuvres and procedures for the rescue of person overboard*
* [OICNW-A9.1]({{site.baseurl}}/tables/21.html#OICNW-A9.1) *squat, shallow-water and similar effects*
* [OICNW-A9.1]({{site.baseurl}}/tables/21.html#OICNW-A9.1) *proper procedures for anchoring and mooring*
* [OICNW-A5.3]({{site.baseurl}}/tables/21.html#OICNW-A5.3) *Appreciation of the procedures to be followed for assisting a ship in distress*
