...
In order to satisfy  [NVIC 14-14  Task  4.9.A](/stcw23/assets/images/nvic-14-14.pdf), MMA students must:

* Successfully complete MMA Assessment {% Practical ABD-4J9A1 %}
* Successfully complete MMA Assessment {% Practical ABD-4J9A2 %}
* Successfully complete MMA Assessment {% Practical ABD-4J9A3 %}
