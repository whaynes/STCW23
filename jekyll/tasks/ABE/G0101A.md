...
In order to satisfy <%= imagelink('nvic-18-14','NVIC 18-14  Task  1.1.A') %> , MMA students must:

Jekyll Link: [NVIC 18-14  Task  1.1.A](/stcw23/assets/images/nvic-18-14.pdf)

* Successfully complete all elements of table  [A-III/4](A-III/4) *ratings forming part of an engineering watch*
