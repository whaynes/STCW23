...
In order to satisfy <%= imagelink('nvic-18-14','NVIC 18-14  Task  7.4.A') %> , MMA students must:

Jekyll Link: [NVIC 18-14  Task  7.4.A](/stcw23/assets/images/nvic-18-14.pdf)
