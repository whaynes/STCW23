...
* Pass MMA Course {% Course ST-0999E %}
* Successfully complete MMA Assessment {% Practical OICEW-2-1A %}
* Successfully complete MMA Assessment {% Practical OICEW-2-1B %}
* Successfully complete MMA Assessment {% Practical OICEW-2-1C %}
