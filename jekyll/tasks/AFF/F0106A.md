...
In order to satisfy <%= imagelink('nvic-09-14','NVIC 09-14  Task  1.6.A') %> , MMA students must:

Jekyll Link: [NVIC 09-14  Task  1.6.A](/stcw23/assets/images/nvic-09-14.pdf)

* Pass MMA Course  [FF-0106](FF-0106) *2/C Firefighting Practicum*
* Successfully complete MMA Assessment  [FF-6PLF](FF-6PLF) *Extinguish a paint locker fire*
