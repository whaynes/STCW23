...
In order to satisfy <%= imagelink('nvic-09-14','NVIC 09-14  Task  2.1.A') %> , MMA students must:

Jekyll Link: [NVIC 09-14  Task  2.1.A](/stcw23/assets/images/nvic-09-14.pdf)
