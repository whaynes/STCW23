...
In order to satisfy <%= imagelink('nvic-09-14','NVIC 09-14  Task  2.1.B') %> , MMA students must:

Jekyll Link: [NVIC 09-14  Task  2.1.B](/stcw23/assets/images/nvic-09-14.pdf)
