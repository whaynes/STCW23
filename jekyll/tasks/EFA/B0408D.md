...
In order to satisfy <%= imagelink('nvic-08-14','NVIC 08-14  Task  4.8.D') %> , MMA students must:

Jekyll Link: [NVIC 08-14  Task  4.8.D](/stcw23/assets/images/nvic-08-14.pdf)

* Successfully complete MMA Assessment  [EFA-4B8D](EFA-4B8D) *Demonstrate preparing patient for spinal immobilization*
