...
In order to satisfy <%= imagelink('nvic-08-14','NVIC 08-14  Task  3.7.A') %> , MMA students must:

Jekyll Link: [NVIC 08-14  Task  3.7.A](/stcw23/assets/images/nvic-08-14.pdf)

* Successfully complete MMA Assessment  [FF-2PFE](FF-2PFE) *Use various types of portable fire extinguishers to extinguish smaller fires.*
