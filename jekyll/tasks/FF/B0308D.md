...
In order to satisfy <%= imagelink('nvic-08-14','NVIC 08-14  Task  3.8.D') %> , MMA students must:

Jekyll Link: [NVIC 08-14  Task  3.8.D](/stcw23/assets/images/nvic-08-14.pdf)

* Successfully complete MMA Assessment  [FF-8SAR](FF-8SAR) *Search and Rescue*
