...
In order to satisfy <%= imagelink('nvic-05-04','NVIC 05-04  Task  1.4.A') %> , MMA students must:

Jekyll Link: [NVIC 05-04  Task  1.4.A](/stcw23/assets/images/nvic-05-04.pdf)

* Successfully complete MMA Assessment  [MFA-1M4A](MFA-1M4A) *Perform CPR*
