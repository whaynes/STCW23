...
In order to satisfy <%= imagelink('nvic-17-14','NVIC 17-14  Task  1.3.A') %> , MMA students must:

Jekyll Link: [NVIC 17-14  Task  1.3.A](/stcw23/assets/images/nvic-17-14.pdf)
