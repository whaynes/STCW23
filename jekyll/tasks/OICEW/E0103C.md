...
In order to satisfy <%= imagelink('nvic-17-14','NVIC 17-14  Task  1.3.C') %> , MMA students must:

Jekyll Link: [NVIC 17-14  Task  1.3.C](/stcw23/assets/images/nvic-17-14.pdf)
