---
title: OICEW Task 4.3.B 
subtitle: Prepare gas turbine for operation
---


### MMA Method

In order to satisfy <%= imagelink('nvic-17-14','NVIC 17-14  Task  4.3.B') %> , MMA students must:

Jekyll Link: [NVIC 17-14  Task  4.3.B](/stcw23/assets/images/nvic-17-14.pdf)

* Successfully complete MMA Assessment  [OICEW-4-3B](OICEW-4-3B) *Prepare and start main gas turbine*
