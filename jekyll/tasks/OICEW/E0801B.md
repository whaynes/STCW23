...
In order to satisfy  [NVIC 17-14  Task  8.1.B](/stcw23/assets/images/nvic-17-14.pdf), MMA students must:

* Pass MMA Course {% Course EN-2112 %}
* Successfully complete MMA Assessment {% Practical OICEW-1-1C %}
* Successfully complete MMA Assessment {% Practical OICEW-1-1B %}
* Successfully complete MMA Assessment {% Practical OICEW-1-1F %}
* Successfully complete MMA Assessment {% Practical OICEW-1-1G %}
