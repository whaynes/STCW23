...
In order to satisfy <%= imagelink('nvic-17-14','NVIC 17-14  Task  8.1.C') %> , MMA students must:

Jekyll Link: [NVIC 17-14  Task  8.1.C](/stcw23/assets/images/nvic-17-14.pdf)

* Successfully complete MMA Assessment  [OICEW-1-1A](OICEW-1-1A) *Cut a circular hole using oxyacetylene process*
