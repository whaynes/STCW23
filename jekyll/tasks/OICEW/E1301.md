...
In order to satisfy <%= imagelink('nvic-17-14','NVIC 17-14  Task  13.1') %> , MMA students must:

Jekyll Link: [NVIC 17-14  Task  13.1](/stcw23/assets/images/nvic-17-14.pdf)
