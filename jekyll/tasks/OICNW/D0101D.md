...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  1.1.D') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  1.1.D](/stcw23/assets/images/nvic-12-14.pdf)

* Successfully complete MMA Assessment  [OICNW-1-1D](OICNW-1-1D) *Measure the altitude of the sun at meridian passage (local apparent noon)*
