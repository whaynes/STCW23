...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  1.3.B') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  1.3.B](/stcw23/assets/images/nvic-12-14.pdf)

* Successfully complete MMA Assessment  [OICNW-1-3B](OICNW-1-3B) *Chart selection*
