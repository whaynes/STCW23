...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  3.2.B') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  3.2.B](/stcw23/assets/images/nvic-12-14.pdf)

* Successfully complete MMA Assessment  [OICNW-3-1B](OICNW-3-1B) *Switch display modes*
