...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  3.5.A') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  3.5.A](/stcw23/assets/images/nvic-12-14.pdf)

* Successfully complete MMA Assessment  [OICNW-3-2A](OICNW-3-2A) *Set up and maintain an ARPA display*
