...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  9.2.B') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  9.2.B](/stcw23/assets/images/nvic-12-14.pdf)

* Successfully complete MMA Assessment  [OICNW-5-1C](OICNW-5-1C) *Emergency stop*
