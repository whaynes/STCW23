...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  11.6') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  11.6](/stcw23/assets/images/nvic-12-14.pdf)
