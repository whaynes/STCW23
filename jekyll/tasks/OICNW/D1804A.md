...
In order to satisfy <%= imagelink('nvic-12-14','NVIC 12-14  Task  18.4.A') %> , MMA students must:

Jekyll Link: [NVIC 12-14  Task  18.4.A](/stcw23/assets/images/nvic-12-14.pdf)
