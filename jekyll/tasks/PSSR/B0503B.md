---
subtitle: PSSR Task 5.3.B 
title: List the steps to take upon seeing or hearing a person fall overboard
---


### MMA Method

In order to satisfy  [NVIC 08-14  Task  5.3.B]({{site.baseurl}}/assets/images/nvic-08-14.pdf), MMA students must:
