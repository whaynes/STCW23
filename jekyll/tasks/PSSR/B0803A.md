...
In order to satisfy <%= imagelink('nvic-08-14','NVIC 08-14  Task  8.3.A') %> , MMA students must:

Jekyll Link: [NVIC 08-14  Task  8.3.A](/stcw23/assets/images/nvic-08-14.pdf)
