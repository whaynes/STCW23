...
In order to satisfy <%= imagelink('nvic-07-14','NVIC 07-14  Task  1.3.A') %> , MMA students must:

Jekyll Link: [NVIC 07-14  Task  1.3.A](/stcw23/assets/images/nvic-07-14.pdf)
