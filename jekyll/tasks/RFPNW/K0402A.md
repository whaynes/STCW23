...
In order to satisfy <%= imagelink('nvic-06-14','NVIC 06-14  Task  4.2.A') %> , MMA students must:

Jekyll Link: [NVIC 06-14  Task  4.2.A](/stcw23/assets/images/nvic-06-14.pdf)
