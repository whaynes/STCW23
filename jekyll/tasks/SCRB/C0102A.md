...
In order to satisfy <%= imagelink('nvic-04-14','NVIC 04-14  Task  1.2.A') %> , MMA students must:

Jekyll Link: [NVIC 04-14  Task  1.2.A](/stcw23/assets/images/nvic-04-14.pdf)
