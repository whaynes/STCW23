...
In order to satisfy <%= imagelink('nvic-04-14','NVIC 04-14  Task  2.1.A') %> , MMA students must:

Jekyll Link: [NVIC 04-14  Task  2.1.A](/stcw23/assets/images/nvic-04-14.pdf)

* Pass MMA Course  [LB-0201](LB-0201) *STCW Lifeboatman Qualifications*
* Successfully complete MMA Assessment  [SCRB-3](SCRB-3) *Start and operate survival craft engine*
